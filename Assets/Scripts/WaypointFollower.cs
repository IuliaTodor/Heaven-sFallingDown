...
public class WaypointFollower : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        //Vector2.Distance: Retorna la distancia entre a y b
        ...
        {
            Debug.Log("Ha entrado en el primer if");
            Debug.Log(currentWaypointIndex);
            //El waypoint al que queremos ir cambia
            currentWaypointIndex++;

            Debug.Log("Tras aumentar: " + currentWaypointIndex);
            Debug.Log("Número waypoints: " + (waypoints.Length-1));
